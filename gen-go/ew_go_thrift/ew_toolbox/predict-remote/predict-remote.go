...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  response get(request req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := ew_toolbox.NewPredictClient(thrift.NewTStandardClient(iprot, oprot))
	...
	case "get":
		...
		argvalue0 := ew_toolbox.NewRequest()
